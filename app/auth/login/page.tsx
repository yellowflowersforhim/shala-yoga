      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">
            Accede a tu cuenta para ver tus inscripciones
          </CardDescription>
        </CardHeader>
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-end">
              <Link href="/auth/forgot-password" className="text-sm text-[hsl(var(--brand-primary))] hover:text-[hsl(var(--brand-primary-dark))]">
        ...
        */}
            <p className="text-sm text-center text-gray-600">
              ...
              <Link href="/auth/register" className="text-[hsl(var(--brand-primary))] hover:text-[hsl(var(--brand-primary-dark))] font-medium">
                Regístrate
              </Link>
            </p>
          </CardFooter>
